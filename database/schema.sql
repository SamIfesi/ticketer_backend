...
CREATE TABLE `event_payouts` (
  ...
  `payout_status` enum('pending','processing','paid','failed','frozen','cancelled','split_settled') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
